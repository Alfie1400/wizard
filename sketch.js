...
function setup() {
 ...
 // dizzy.addImage(stunnedImg)
  ...
  gameOver = createSprite(width-600,height-400)
  ...
  win = createSprite(width-625,height-300)
  win.addImage(winImg)
  win.scale = 0.7
  win.visible=false
...
function bulletHit(toad,sprite){
  sprite.destroy()
  console.log(sprite.x,sprite.y,"hi")
  bulletit = 'pyaaz'
